...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-slate-900 text-white z-30 flex flex-col transform transition-transform duration-200 ease-in-out
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-700">
          ...
          <span className="font-bold text-lg tracking-tight">WorshipFlow</span>
        </div>
        ...
        {/* Profile / Settings */}
        <div className="px-3 pb-2 border-t border-slate-700 pt-2 space-y-1">
          {BOTTOM_NAV_ITEMS.filter((item) => !item.adminOnly || user?.role === 'ADMIN').map(
            (item) => {
